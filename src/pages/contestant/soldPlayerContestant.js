...
import { soldPlayers } from '../../redux/actions/playerAction';
            ...
            <div className='tasks-body'>
              ...
              <div className='task_body'>
                <div className='task_body_title mt-5 pb-3'>
                  ...
                  <div className='title-h5'>Sold Price</div>
                </div>
                {teams ? teams.map(player => (
                  <>
                    <div className='task-inside-body-2 pb-1'>
                      ...
                      <div className='title-c5'>{player.price} C</div>
                    </div>
